...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0qwajcw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0qwajcw.containers.anotherwebservice.com/
...
```
git clone git@github.com:diogo0587/container-0qwajcw.git
cd container-0qwajcw
```
...
```
docker attach container-0qwajcw
```
